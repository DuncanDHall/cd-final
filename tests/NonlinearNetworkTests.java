...
public class NonlinearNetworkTests {
    ...
    public void testRingNetworks1() {
        ...
        expectedEvents[2] = new AODVEvent(2, 1, nodes[2], nodes[0], nodes[0], nodes[1], "");
        expectedEvents[3] = new AODVEvent(2, 1, nodes[2], nodes[1], nodes[0], nodes[1], "");
        expectedEvents[4] = new AODVEvent(2, 2, nodes[1], nodes[0], nodes[1], nodes[0], "");
        expectedEvents[5] = new AODVEvent(3, 0, nodes[0], nodes[1], nodes[0], nodes[1], "<node 0 to node 1>");
    ...
    public void testRingNetworks2() {
        ...
        expectedEvents[8] = new AODVEvent(5, 0, nodes[0], nodes[1], nodes[0], nodes[2], "<node 0 to node 2>");
        expectedEvents[9] = new AODVEvent(6, 0, nodes[1], nodes[2], nodes[0], nodes[2], "<node 0 to node 2>");
